...
<div class="content">
	<table class="table list-table">
		...
		<caption class="row">
			<form name="serachuser" action="<?php echo IUrl::creatUrl("/");?>" method="get" class="form-inline col-sm-8">
			...
			<form action="<?php echo IUrl::creatUrl("/market/clear_log/type/operation");?>" method="post" name='clear_log' class="form-inline col-sm-4">
		...
		<tbody>
			...
			<?php foreach($items=$this->operationList as $key => $item){?>
			<tr>
				<td><?php echo isset($item['author'])?$item['author']:"";?></td>
				<td><?php echo isset($item['action'])?$item['action']:"";?></td>
				<td style="word-break: break-all;"><?php echo isset($item['content'])?$item['content']:"";?></td>
...
<?php echo $this->operationObj->getPageBar();?>
