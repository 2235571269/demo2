...
<script type="text/javascript" charset="UTF-8" src="/iWebShop5.5/runtime/_systemjs/echarts/echarts.simple.min.js"></script>
...
<div class="content">
	<form action='<?php echo IUrl::creatUrl("/");?>' method='get' class="form-inline" name="searchForm">
		...
		<button class="btn btn-default" type="button" onclick="submitForm('spanding_avg');">
		    <i class="fa fa-search"></i> 查询
		</button>

		<button class="btn btn-default" onclick="submitForm('spanding_report')">
