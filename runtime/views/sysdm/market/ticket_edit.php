		...
		<table class="table form-table">
                    ...
                    <div class="row">
                        <div class="col-xs-4">
                            <div class="input-group">
                                ...
                                <input class="form-control" type="text" name="start_time" onfocus="WdatePicker()" value="" placeholder="起始日期" />
                            </div>
                        </div>
                        <div class="col-xs-4">
                            <div class="input-group">
                                <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                <input class="form-control" type="text" name="end_time" onfocus="WdatePicker()" value="" placeholder="结束日期" />
                            </div>
                        </div>
                    </div>
			...
			<tr>
				...
				<td>
					...
					<p class="help-block">设置兑换此优惠券所需要的用户积分，如果为空或0则表示此优惠券不支持积分兑换，只支持管理员动手生成</p>
				</td>
			</tr>
...
formObj.init(<?php echo JSON::encode($this->ticketRow);?>);
