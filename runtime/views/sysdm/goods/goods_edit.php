			...
			<div class="tab-pane active" id="tab1">
				<table class="table form-table">
					...
					<tr>
						<th>附件上传：</th>
						<td>
							<?php if(isset($form['download[file]'])){?>
							<p><a href="<?php echo isset($form['download[file]'])?$form['download[file]']:"";?>" target="_blank"><?php echo isset($form['download[file]'])?$form['download[file]']:"";?></a></p>
							...
							<?php }?>
							<p class="help-block">文件格式为ZIP压缩包，大小不得超过<?php echo IUpload::getMaxSize();?></p>
						</td>
					</tr>
					<tr>
						<th>截止时间：</th>
						<td>
							<div class="input-group col-md-3">
								<input class="form-control" pattern='date' type="text" name="download[end_time]" onfocus="WdatePicker()" value="" />
                    ...
                    <tr>
                        <th>接收短信：</th>
                        <td>
                            <a href="<?php echo IUrl::creatUrl("/system/hsms");?>" target="_blank">短信服务配置</a>
                    ...
                    <?php if(goods_class::isDelivery($type)){?>
					<tr>
						<th>是否免运费：</th>
						<td>
                            <label class="radio-inline">
