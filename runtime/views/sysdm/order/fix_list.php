...
<div class="content">
	<form name="orderForm" action="<?php echo IUrl::creatUrl("/order/fix_doc_del");?>" method="post">
	<table class="table list-table">
		...
		<tbody>
			<?php $queryObj=Api::run('getFixList');$resultData=$queryObj->find()?>
			...
			<tr>
				...
				<td><a href="<?php echo IUrl::creatUrl("/order/fix_doc_show/id/".$item['id']."");?>"><i class='operator fa fa-eye'></i></a></td>
			</tr>
			<?php }?>
		</tbody>
	</table>
