...
<div class="content">
	...
	<table class="table list-table">
		...
		<tbody>
			<?php $queryObj=Api::run('getRefundmentList');$resultData=$queryObj->find()?>
			...
			<tr>
				...
				<td><a href="<?php echo IUrl::creatUrl("/order/refundment_doc_show/id/".$item['id']."");?>"><i class='operator fa fa-eye'></i></a></td>
			</tr>
			<?php }?>
		</tbody>
	</table>
