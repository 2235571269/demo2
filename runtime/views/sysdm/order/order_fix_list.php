...
<body class="skin-blue fixed sidebar-mini" style="height: auto; min-height: 100%;">
	...
	<ul class="breadcrumb">
		...
		<li class="active">维修单列表</li>
	</ul>
</div>

<div class="content">
	<form name="orderForm" action="<?php echo IUrl::creatUrl("/order/fix_del");?>" method="post">
	<table class="table list-table">
		...
		<caption>
            ...
            <a class="btn btn-default" href='<?php echo IUrl::creatUrl("/order/fix_recycle_list");?>'>
		...
		<tbody>
            <?php $queryObj=Api::run('getListByOrderFix');$resultData=$queryObj->find()?>
			...
			<tr>
				...
				<td><a href="<?php echo IUrl::creatUrl("/order/fix_show/id/".$item['id']."");?>"><i class='operator fa fa-eye'></i></a></td>
			</tr>
			<?php }?>
		</tbody>
	</table>
