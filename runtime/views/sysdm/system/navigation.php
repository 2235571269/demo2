...
<div class="content">
	<form name='admin_list' method='post' action='<?php echo IUrl::creatUrl("/system/navigation_del");?>'>
		<table class="table list-table">
			...
			<caption>
                <a class="btn btn-default" href='<?php echo IUrl::creatUrl("/system/navigation_edit");?>'>
                    <i class="fa fa-plus"></i>添加快速导航
                </a>
                ...
                <a class="btn btn-default" href='<?php echo IUrl::creatUrl("/system/navigation_recycle");?>'>
			...
			<tbody>
				<?php $queryObj=Api::run('getListByQuickNaviga',array('is_del'=>0));$resultData=$queryObj->find()?>
				...
				<tr>
					...
					<td>
						<a href='<?php echo IUrl::creatUrl("/system/navigation_edit/id/".$item['id']."");?>'><i class='operator fa fa-edit'></i></a>
						<a href="javascript:delModel({link:'<?php echo IUrl::creatUrl("/system/navigation_del/id/".$item['id']."");?>'});"><i class='operator fa fa-close'></i></a>
					</td>
				</tr>
				<?php }?>
			</tbody>
