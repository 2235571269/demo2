...
<div class="breadcrumbs" id="breadcrumbs">
	<ul class="breadcrumb">
		...
		<li>
			<a href="<?php echo IUrl::creatUrl("/comment/discussion_list");?>">讨论管理</a>
		</li>
...
<div class="content">
	<table class="table list-table">
		...
		<caption>
			...
			<form class="form-inline" method="get" action="<?php echo IUrl::creatUrl("/");?>">
		...
		<tbody>
			<?php $queryObj=Api::run('getListByDiscussion');$resultData=$queryObj->find()?>
			...
			<tr>
				...
				<td>
					<a href="<?php echo IUrl::creatUrl("/comment/discussion_edit/id/".$item['id']."");?>"><i class='operator fa fa-edit'></i></a>
					<a onclick="delModel({link:'<?php echo IUrl::creatUrl("/comment/discussion_del/check/".$item['id']."");?>'})"><i class='operator fa fa-close'></i></a>
				</td>
			</tr>
			<?php }?>
		</tbody>
