...
<div class="breadcrumbs" id="breadcrumbs">
	<ul class="breadcrumb">
		...
		<li>
			<a href="<?php echo IUrl::creatUrl("/comment/comment_list");?>">评价管理</a>
		</li>
...
<div class="content">
	<table class="table list-table">
		...
		<caption>
			...
			<form class="form-inline" action="<?php echo IUrl::creatUrl("/");?>" method="get">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a href="<?php echo IUrl::creatUrl("/comment/comment_edit/cid/".$item['id']."");?>"><i class='operator fa fa-eye'></i></a>
					<a href="javascript:delModel({link:'<?php echo IUrl::creatUrl("/comment/comment_del/check/".$item['id']."");?>'})"><i class='operator fa fa-close'></i></a>
				</td>
			</tr>
			<?php }?>
		</tbody>
