	...
	<table class="table list-table">
		...
		<tbody>
			...
			<tr>
				...
				<td><?php if($item['re_time']>0){?><?php echo isset($item['re_time'])?$item['re_time']:"";?><?php }else{?>未回复<?php }?></td>
				<td>
					<a href="<?php echo IUrl::creatUrl("/comment/suggestion_edit/id/".$item['id']."");?>"><i class='operator fa fa-edit'></i></a>
					<a onclick="delModel({link:'<?php echo IUrl::creatUrl("/comment/suggestion_del/check/".$item['id']."");?>'})"><i class='operator fa fa-close'></i></a>
				</td>
			</tr>
			<?php }?>
		</tbody>
