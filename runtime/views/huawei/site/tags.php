...
<div class="bigweb">
    <section class="breadcrumb">
    	<span>您当前的位置：</span> <a href="<?php echo IUrl::creatUrl("");?>">首页</a> » 标签
    </section>

    <section class="tags_box">
    	<?php foreach($items=Api::run('getKeywordAllList',100) as $key => $item){?>
    	<?php $keyword=urlencode($item['word']);?>
    	<a href="<?php echo IUrl::creatUrl("/site/search_list/word/".$keyword."");?>"><?php echo isset($item['word'])?$item['word']:"";?></a>
    	<?php }?>
    </section>
</div>
</div>
