	...
	<aside class="bar">
		<div class="bar_box">
			...
			<div class="bar_seller">
				...
				<p id="mapContainer" style="width:100%;height:200px;border:1px solid #ddd;"></p>
			</div>
		</div>
		...
		<div class="bar_box">
			...
			<ul class="bar_goods ranking">
				<?php foreach($items=Api::run('getGoodsListBySellerid',array('#seller_id#',$seller_id),10,'sale-') as $key => $item){?>
				<li>
...
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=tsyGQXzhWIU4eYNkXyI47LjeK5Og5Vxf"></script>
<script>


$(function(){
	$lat=<?php echo isset($sellerRow['lat'])?$sellerRow['lat']:"";?>;
	$lng=<?php echo isset($sellerRow['lng'])?$sellerRow['lng']:"";?>;
	...
	map.centerAndZoom(point,15);
	 ...
	 var infoWindow = new BMap.InfoWindow('海淀',opts);
