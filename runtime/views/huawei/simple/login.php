...
﻿<section class="web">
	...
	<section class="login_box">
		<form action='<?php echo IUrl::creatUrl("/user/login_act");?>' method='post'>
			<?php if($this->getError()){?>
			<div class="prompt">
				<?php echo $this->getError();?>
			</div>
			<?php }?>
			<a href="<?php echo IUrl::creatUrl("/simple/tellogin");?>">切换手机号登录</a>
			<dl>
			...
			<dl>
				...
				<a href="<?php echo IUrl::creatUrl("/simple/oauth_login?id=2");?>"><img src="<?php echo IUrl::creatUrl("")."public/img/qq.png";?>" alt=""></a>
			</dl>
		</form>
