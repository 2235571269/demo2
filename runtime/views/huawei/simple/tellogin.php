...
<section class="web">
	...
	<section class="login_box">
		<form action="<?php echo IUrl::creatUrl("/user/telLogin");?>" method="post" id="mobileWay" >
			<a href="<?php echo IUrl::creatUrl("/simple/login");?>">切换密码登录</a>
			<dl>
				<dt>手机号：</dt>
				<dd>
...
$('#sendreg').click(function(){
		...
		$.ajax({
			type:'post',
			url:"<?php echo IUrl::creatUrl("/user/sendlogin");?>",
			data:{tel:tel},
