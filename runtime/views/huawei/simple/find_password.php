...
<section class="web">
	...
	<section class="reg_box">
		<form action="<?php echo IUrl::creatUrl("/user/find_password_email");?>" method="post" id="mailWay">
			<dl>
				<dt>用户名：</dt>
		...
		<form action="<?php echo IUrl::creatUrl("/user/find_password_mobile");?>" method="post" id="mobileWay" style="display:none">
			<dl>
				<dt>用户名：</dt>
				<dd><input name="username" class="input_text" type="text" pattern="required" alt="请输入正确的用户名" /></dd>
			</dl>
			<dl>
				<dt>手机号：</dt>
				<dd>
					<input name="mobile" class="input_text" type="text" id="tel" pattern="mobi" alt="请输入正确的手机号" />
				</dd>
			</dl>
			<dl>
				<dt>手机验证码：</dt>
				<dd>
					...
					<input class="input_button" id="sendfind" type="button" value="获取验证码">
				</dd>
			</dl>
			<dl>
				<dt></dt>
...
<section id="fp_success" style="display:none" class="prompt_page success">
	...
	<article>
		...
		您现在可以去：<a href="<?php echo IUrl::creatUrl("");?>">商城首页</a> <a href="<?php echo IUrl::creatUrl("/ucenter/index");?>">用户中心</a>
	</article>
</section>
...
$('#sendfind').click(function(){
		...
		$.ajax({
			type:'post',
			url:"<?php echo IUrl::creatUrl("/user/sendfind");?>",
			data:{tel:tel},
