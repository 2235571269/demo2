...
<div class="center_content">
	...
	<h3 class="current"><a href="<?php echo IUrl::creatUrl("/ucenter/account_log");?>">交易记录</a></h3>
	<h3><a href='<?php echo IUrl::creatUrl("/ucenter/withdraw");?>'>提现申请</a></h3>
</header>
...
<section class="uc_table">
	<table>
		...
		<tbody>
			<?php $queryAccountLogList = Api::run('getUcenterAccoutLog')?>
			<?php foreach($items=$queryAccountLogList->find() as $key => $item){?>
			<tr>
