...
<section class="uc_info">
	...
	<div class="user_ico">
		<img id="user_ico_img" onclick="$('#userIcoFile').trigger('click');" src="<?php echo IUrl::creatUrl("".$user_ico."");?>" onerror="this.src='<?php echo $this->getWebSkinPath()."image/user_ico.gif";?>'">
	</div>
	<div class="user_info">
		...
		<ol class="user_stat">
			...
			<li>优惠券：<strong><?php echo isset($propData['prop_num'])?$propData['prop_num']:"";?></strong> 张</li>
...
<input id="userIcoFile" style="display:none;" type="file" accept="image/png,image/gif,image/jpeg" name="userIcoFile" data-url="<?php echo IUrl::creatUrl("/ucenter/user_ico_upload");?>" />
