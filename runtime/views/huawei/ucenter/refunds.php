...
<div class="center_content">
	...
	<h3 class="current"><a href="<?php echo IUrl::creatUrl("/ucenter/refunds");?>">我的退款</a></h3>
	<h3><a href="<?php echo IUrl::creatUrl("/ucenter/exchange");?>">我的换货</a></h3>
	<h3><a href="<?php echo IUrl::creatUrl("/ucenter/fix");?>">我的维修</a></h3>
</header>
...
<section class="uc_table">
	<table>
		...
		<tbody>
		<?php $queryRefundmentDocList = Api::run('getRefundmentDocList')?>
		<?php foreach($items=$queryRefundmentDocList->find() as $key => $item){?>
		<tr>
			...
			<td>
				<?php if($item['pay_status']==0){?><a href='javascript:delModel({link:"<?php echo IUrl::creatUrl("/ucenter/refunds_del/id/".$item['id']."");?>"})'>取消</a>|<?php }?>
				<a href="<?php echo IUrl::creatUrl("/ucenter/refunds_detail/id/".$item['id']."");?>">查看</a>
			</td>
		</tr>
		<?php }?>
		</tbody>
...
<?php echo $queryRefundmentDocList->getPageBar();?>
